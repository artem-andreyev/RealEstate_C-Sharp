// абстрактный класс нельзя использовать напрямую, а только в наследниках, нужен для того чтобы описать нечто абстрактное, обязан к реализации впоследствии.
...
public abstract class RealEstate
{
    ...
    public RealEstate(string address, double area) : this(address, area, DateTime.MinValue, DateTime.MinValue) { } // Это делается для упрощения создания экземпляров класса RealEstate, когда время еще не важно
